...
const PANELS = {
  ...
  doctrine: {
    ...
    members: [
      { name: "아우구스티누스", note: "고대 라틴 교부. 종교개혁과 동서 분열 이전, 서방 고대 교회가 이 물음을 어떻게 보았는지 기준선을 제시합니다. 뒤의 서방 신학자들이 모두 그를 근거로 삼되 서로 다르게 해석했음을 염두에 두십시오. 다만 그를 '초대교회 전체의 입장'으로 말하지는 마십시오 — 동방이 그와 갈라지는 지점이 있습니다." },
      { name: "다마스쿠스의 요한", note: "동방 정교. 동방 교부 전통. 아우구스티누스와 갈라지는 지점이 있으면 분명히 드러내십시오." },
